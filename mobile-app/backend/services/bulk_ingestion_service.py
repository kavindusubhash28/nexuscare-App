import logging
import uuid
from services.supabase_storage_service import list_all_files_recursively, SUPABASE_STORAGE_BUCKET, SUPABASE_URL
from services.lab_upload_ingestion_service import trigger_rag_ingestion_async
