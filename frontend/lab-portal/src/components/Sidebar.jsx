  ...
  return (
    <aside className="lb-sidebar">
      ...
      <div className="lb-sidebar-nav">
        ...
        <NavItem to="/operations/recommended" icon={<FlaskIcon />} label="Recommended Tests" />
        <NavItem to="/operations/requests" icon={<ClipboardIcon />} label="Test Requests" />
        <NavItem to="/operations/upload" icon={<UploadIcon />} label="Upload Reports" />
        <NavItem to="/operations/reports" icon={<HistoryIcon />} label="Reports History" />
        <NavItem to="/operations/patient-history" icon={<UserIcon />} label="Patient Lab History" />

        <div className="lb-sidebar-section-label" style={{ marginTop: 8 }}>Lab Management</div>
        <NavItem to="/management/tests" icon={<BeakerIcon />} label="Offered Tests" />
        ...
        <NavItem to="/settings/performance" icon={<BarChartIcon />} label="Performance Stats" />
